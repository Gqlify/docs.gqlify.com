...
const siteConfig = {
  ...
  headerIcon: 'img/gqlify.svg',
  footerIcon: 'img/gqlify.svg',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Gqlify.  Canner. Inc.`,
  ...
  usePrism: ['jsx', 'js', 'typescript', 'bash', 'json', 'graphql'],
  ...
  // edit url
  editUrl: 'https://github.com/Canner/docs.gqlify.com/edit/master/docs/',
};
